...
plot(count_fit_week$forecast, sim.train, truth=sim.test, alpha = 0.2)
PILAF::evaluate(count_fit_week$forecast, sim.test, 'count', color = 'steelblue')
```
...
PILAF::evaluate(joint_fit_week$forecast, sim.test, 'phylo', color = 'orange')
```
