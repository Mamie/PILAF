...
# H3N2
H3N2 <- preprocess_fasta("inst/extdata/H3N2/NewYork_A_H3N2_20190307.fasta")
H3N2_filtered <- filter_date(H3N2, "2014-01-01", "inst/extdata/H3N2/NewYork_A_H3N2_20190307_filtered.tsv", "inst/extdata/H3N2/NewYork_A_H3N2_20190307_filtered.fasta") # 265
H3N2_last_time <- 2019.0739726027398

# H1N1
H1N1 <- preprocess_fasta("inst/extdata/H1N1/20180318_NewYork_H1N1.fasta")
H1N1_filtered <- filter_date(H1N1, "2014-01-01", "inst/extdata/NewYork_A_H3N2_20190307_filtered.tsv", "inst/extdata/H1N1/NewYork_A_H1N1_20190318_filtered.fasta") # 265
H1N1_last_time <- 2019.0931506849315

# B
Yamagata <- preprocess_fasta("inst/extdata/Yamagata/20190315_NewYork_B_Yamagata.fasta")
...
# B
Victoria <- preprocess_fasta("inst/extdata/Victoria/20190315_NewYork_B_Victoria.fasta")
...
p <- ggplot(data = H3N2_filtered$field) +
