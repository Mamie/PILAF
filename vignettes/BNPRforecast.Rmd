...
forecast_2017week46 <- forecast_starting(H3N2_tree, last_time = H3N2_last_time, week_start = 45, 
                  year_start = 2015, formula = BNPR_PS_formula, pred = 5)
forecast_2018week2 <- forecast_starting(H3N2_tree, last_time = H3N2_last_time, week_start = 1, 
                  year_start = 2018, formula = BNPR_PS_formula, pred = 4)
forecast_2018week11 <- forecast_starting(H3N2_tree, last_time = H3N2_last_time, week_start = 10, 
                  year_start = 2018, formula = BNPR_PS_formula, pred = 5)

# plot the forecast
H3N2_PS_df <- BNPR_to_df(forecast_2019week46, label = "H3N2 BNPR PS", forecast_2019week46$truncation_time)
plot_trajectory(H3N2_PS_df, c(min(H3N2_PS_df$Lower), max(H3N2_PS_df$Upper)), seq(2014, 2019), H3N2_root_time, vline = forecast_2019week46$truncation_time - forecast_2019week46$result$summary.random$time$ID[4])
```
