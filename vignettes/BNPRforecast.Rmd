...
forecast_2015week40 <- forecast_starting(H3N2_tree, last_time = H3N2_last_time, week_start = 40, 
                  year_start = 2015, formula = BNPR_PS_formula)

# plot the forecast
H3N2_PS_df <- BNPR_to_df(forecast_2015week40, label = "H3N2 BNPR PS", forecast_2015week40$truncation_time)
plot_trajectory(H3N2_PS_df, c(min(H3N2_PS_df$Lower), max(H3N2_PS_df$Upper)), seq(2014, 2015), H3N2_root_time, vline = forecast_2015week40$truncation_time - H3N2_Ne_forecast$result$summary.random$time$ID[4])
```
