...
p <- plot(sim.data)
ggsave(p, file='../../manuscript/Figures/simulation/simulatedTraj.pdf', width = 5,
       height = 5)
```
...
joint_fit_week = forecast(sim.train, test.time, PILAF:::Convert2Week(test.time),
                          formula = formula, return_model = T, method = 'joint', verbose=F)
...
p
ggsave(p, file = '../../manuscript/figures/simulation/simulation-results.pdf',
       width = 5, height = 3)
```
